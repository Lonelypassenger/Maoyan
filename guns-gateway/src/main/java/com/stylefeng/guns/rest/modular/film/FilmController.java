 ...
 * @AUTHOR :yuankejia
 * @DESCRIPTION:
 * @DATE:CRETED: IN 14:09 2019/10/25
 * @MODIFY:
 */
@RestController
@RequestMapping("/film/")
public class FilmController {
    ...
    private static String IMG_SOURCE = "sdfafa";
     ...
     * 用于请求首页
     * API网关在这里体现的是功能聚合
     * 好处：留个接口一次请求，节省了五次http请求
     * 同一个接口对外暴露，降低了前后端分离的难度和复杂度
     * @return
     */
    ...
    public ResponseVO getIndex(){
        ...
        return ResponseVO.success(IMG_SOURCE,filmIndexVO);
    }
